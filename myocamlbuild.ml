(* OASIS_START *)
(* DO NOT EDIT (digest: f6563a91c84de70954848c68321433c4) *)
...
let package_default =
  {
     ...
     flags =
       [
          ...
          (["oasis_library_slap_cclib"; "ocamlmklib"; "c"],
            [
               (OASISExpr.EBool true, S [A "-lblas"; A "-llapack"]);
               (OASISExpr.ETest ("system", "macosx"),
                 S [A "-lblas"; A "-llapack"; A "-framework"; A "Accelerate"])
            ])
       ];
     includes =
       [
          ...
          ("examples/neural-network/logistic-regression", ["lib"]);
          ("examples/mult", ["lib"]);
          ("examples/linsys", ["lib"])
       ]
  }
