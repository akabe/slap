...
(* OASIS_START *)
(* DO NOT EDIT (digest: a496539efedf8f9da2eceaa19371e06e) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ...
          ("slap_ppx",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "ppx"})
       ];
     ...
     package =
       {
          ...
          license_file = None;
          copyrights =
            ["(C) 2013-2015 Akinori ABE <abe@sf.ecei.tohoku.ac.jp>"];
          maintainers = ["Akinori ABE <abe@sf.ecei.tohoku.ac.jp>"];
          authors = ["Akinori ABE <abe@sf.ecei.tohoku.ac.jp>"];
          homepage = Some "http://akabe.github.io/slap/";
          synopsis =
            "A linear algebra library with static size checking for\nmatrix operations";
          description =
            Some
              [
                 OASISText.Para
                      ...
                      Some
                        (("ocaml",
                           [
                              ...
                              "-V";
                              "OCAML:$(ocaml_version)";
                              "lib/slap_size.cppo.mli";
                              ">";
                              "lib/slap_size.mli;";
                              "\\\ncppo";
                              "-V";
                              "OCAML:$(ocaml_version)";
                              "lib/slap_size.cppo.ml";
                              ">";
                              "lib/slap_size.ml;";
                              "\\\ncppo";
                              "-V";
                              "OCAML:$(ocaml_version)";
                              "lib/slap_vec.cppo.mli";
                              ">";
                              "lib/slap_vec.mli;";
                              "\\\ncppo";
                              "-V";
                              "OCAML:$(ocaml_version)";
                              "lib/slap_vec.cppo.ml";
                              ">";
                              "lib/slap_vec.ml;";
                              "\\\ncppo";
                              "-V";
                              "OCAML:$(ocaml_version)";
                              "lib/slap_mat.cppo.mli";
                              ">";
                              "lib/slap_mat.mli;";
                              "\\\ncppo";
                              "-V";
                              "OCAML:$(ocaml_version)";
                              "lib/slap_mat.cppo.ml";
                              ">";
                              "lib/slap_mat.ml;";
                              "\\\ncppo";
                              "-V";
                              "OCAML:$(ocaml_version)";
                              "lib/slap_SD.cppo.mli";
                              "|";
                              "sed";
                              "'s/XSDCZ/S/g;s/XBITS/32/g'";
                              ">";
                              "lib/slap_S.mli;";
                              "\\\ncppo";
                              "-V";
                              ...
                              "-V";
                              "OCAML:$(ocaml_version)";
                              "lib/slap_CZ.cppo.mli";
                              "|";
                              "sed";
                              "'s/XSDCZ/C/g;s/XBITS/32/g'";
                              ">";
                              "lib/slap_C.mli;";
                              "\\\ncppo";
                              "-V";
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Build ppx_slap";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("lacaml",
                               Some (OASISVersion.VGreaterEqual "8.0.0"))
                        ];
                      bs_build_tools =
                        [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Install_top"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "slap";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "ppx";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "slap"];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                           ExternalTool "ocamldoc";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_slap.ml"});
               Doc
                 ({
                     cs_name = "slap";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      doc_title = "SLAP API Documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir/ppx";
                      doc_title = "SLAP PPX Documentation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_working_directory = Some "test/lib";
                      test_run =
                        [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "gemv_gbmv.ml"});
               Executable
                 ({
                     cs_name = "symv_sbmv";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "symv_sbmv.ml"});
               Executable
                 ({
                     cs_name = "gesv_gbsv";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "gesv_gbsv.ml"});
               Executable
                 ({
                     cs_name = "trsv_tpsv";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "trsv_tpsv.ml"});
               Executable
                 ({
                     cs_name = "posv_ppsv_pbsv";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "posv_ppsv_pbsv.ml"});
               Executable
                 ({
                     cs_name = "perceptron";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/neural-network/perceptron";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "slap"];
                      bs_build_tools =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "perceptron.ml"});
               Executable
                 ({
                     cs_name = "logistic_regression";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/neural-network/logistic-regression";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "slap"];
                      bs_build_tools =
                        [
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "logistic_regression.ml"
                   });
               Executable
                 ({
                     cs_name = "two_layer_neural_network";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/neural-network/two-layer";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "slap"];
                      bs_build_tools =
                        [
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "two_layer_neural_network.ml"
                   });
               Executable
                 ({
                     cs_name = "multilayer_neural_network";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/neural-network/multilayer";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "slap"];
                      bs_build_tools =
                        [
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "multilayer_neural_network.ml"
                   });
               Executable
                 ({
                     cs_name = "qr_lacaml";
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/porting/qr_factorize";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("lacaml", None)];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                           ExternalTool "ocamldoc";
                   ...
                   {exec_custom = false; exec_main_is = "qr_lacaml.ml"});
               Executable
                 ({
                     cs_name = "qr_slap";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "qr_slap.ml"});
               Executable
                 ({
                     cs_name = "lu_lacaml";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/porting/lu_factorize";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("lacaml", None)];
                      bs_build_tools =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "lu_lacaml.ml"});
               Executable
                 ({
                     cs_name = "lu_slap";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "lu_slap.ml"});
               Executable
                 ({
                     cs_name = "perceptron_lacaml";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/porting/perceptron";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("lacaml", None)];
                      bs_build_tools =
                        [
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "perceptron_lacaml.ml"
                   });
               Executable
                 ({
                     cs_name = "perceptron_slap";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "perceptron_slap.ml"});
               Executable
                 ({
                     cs_name = "kmeans_lacaml";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/porting/k-means";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("lacaml", None)];
                      bs_build_tools =
                        [
                   ...
                   {exec_custom = false; exec_main_is = "kmeans_lacaml.ml"});
               Executable
                 ({
                     cs_name = "kmeans_slap";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "kmeans_slap.ml"});
               Executable
                 ({
                     cs_name = "pca_lacaml";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "pca_lacaml.ml"});
               Executable
                 ({
                     cs_name = "pca_slap";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "pca_slap.ml"});
               Executable
                 ({
                     cs_name = "steepest_descent";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "steepest_descent.ml"
                   });
               Executable
                 ({
                     cs_name = "steepest_descent_wolfe";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "steepest_descent_wolfe.ml"
                   });
               Executable
                 ({
                     cs_name = "newton";
                   ...
                   {exec_custom = false; exec_main_is = "newton.ml"});
               Executable
                 ({
                     cs_name = "quasi_newton";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "quasi_newton.ml"});
               Executable
                 ({
                     cs_name = "optimization_visualization";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "visualization.ml"});
               SrcRepo
                 ({
                     cs_name = "head";
                     cs_data = PropList.Data.create ();
                   ...
                   {
                      src_repo_type = Git;
                      src_repo_location = "https://github.com/akabe/slap.git";
                      src_repo_browser = Some "https://github.com/akabe/slap";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\154\000\144Y\252 \153e%\197\226\185\207uz\007";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
