...
(* OASIS_START *)
(* DO NOT EDIT (digest: ec0d98113af5d14afe5fd7710df48c4a) *)
(*
...
let setup_t =
  {
     ...
     doc = [("slap", OCamlbuildDocPlugin.doc_build "lib")];
     ...
     clean_doc = [("slap", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test =
       [
          ("test",
     ...
     package =
       {
          ...
          description =
            Some
              "BLAS and LAPACK binding in OCaml with static size checking for matrix operations";
          categories = [];
     ...
     oasis_version = "0.4.1";
     oasis_digest = Some "\250\137\027\n\220\026\015\151\173%\236e\142\157KR";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
