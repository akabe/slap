...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0a056ae990f8d572002987d5c261e2cc) *)
(*
...
let setup_t =
  {
          ...
          clean_custom =
            {
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("rm", ["-rf"; "lib/slap.ml"; "lib/slap.mli"])))
                 ]
            };
          distclean_custom =
            {
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources =
                        ["slap_utils.h"; "slap_utils.c"; "slap_mat_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                           (OASISExpr.EBool true,
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "oN\226\235\239,\1699E\228\145c3\204`j";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
