...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8e31d752a9cdfc5fdd331f7cbe456083) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "jacobi.ml"});
               Executable
                 ({
                     cs_name = "gesv_gbsv";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "@\018\180mK\141~\0268>\020\138\240\178\234\151";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
