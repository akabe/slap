...
(* OASIS_START *)
(* DO NOT EDIT (digest: 45a03bff0d89f1c35a47fda9923599d9) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          license_file = None;
          copyrights =
            ["(C) 2013-2014 Akinori ABE <abe@sf.ecei.tohoku.ac.jp>"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\214\223s\209N+\249\160\021x:\163_\189{\250";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
