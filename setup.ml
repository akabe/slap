...
(* OASIS_START *)
(* DO NOT EDIT (digest: ca980679baa6a0892e2149c8265fc48a) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/akabe/slap";
          synopsis =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\177 C\141{\152\238[\186\012ci\024\252\004\170";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
