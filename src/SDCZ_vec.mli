...
val init : 'n Size.t -> (int -> num_type) -> ('n, 'cnt) vec
(** [init n f]
...
val shared_rev : ('n, 'cd) vec -> ('n, Misc.dsc) vec
(** [shared_rev (x1, x2, ..., xn)]
...
val unsafe_of_array :
  'n Size.t -> num_type array -> ('n, 'cnt) vec
...
val unsafe_of_list :
  'n Size.t -> num_type list -> ('n, 'cnt) vec
...
val of_array_c :
  num_type array -> (num_type, prec, 'cnt) Vec.dyn
...
val of_list_c :
  num_type list -> (num_type, prec, 'cnt) Vec.dyn
