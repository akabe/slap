...
sig
  ...
  (** [set_dim_defaults opt_n] sets both {!Io.Context.vertical_default} and
      {!Io.Context.horizontal_default} to [opt_n].
   *)
end
...
sig
  ...
  (** {i SLAP Set Context}: [ssc n] sets sets both
      {!Io.Context.vertical_default} and
      {!Io.Context.horizontal_default} to [Some n].
      This is the shortcut version of {Io.Context.set_dim_defaults}.
   *)
