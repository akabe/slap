...
(** Like {!Mat.get_dyn}, but size checking is not always performed. *)

val unsafe_set : ('m, 'n, 'num, 'prec, 'cd) t -> int -> int -> 'num -> unit
(** Like {!Mat.set_dyn}, but size checking is not always performed. *)
...
val diag : ('n, 'n, 'num, 'prec, 'cd) t -> ('n, 'num, 'prec, dsc) Vec.t
(** [diag a]
...
val diag_rect :
  ('m, 'n, 'num, 'prec, 'cd) t ->
  (('m, 'n) Size.min, 'num, 'prec, dsc) Vec.t
(** [diag_rect a]
...
val luband_dyn :
  'kl Size.t -> 'ku Size.t ->
  ?ab:(('m, 'n, 'kl, 'ku) Size.luband, 'n, 'num, 'prec, 'b_cd) t ->
  ('m, 'n, 'num, 'prec, 'a_cd) t ->
...
val fold_left :
  ('accum -> ('m, 'num, 'prec, 'x_cd) Vec.t -> 'accum) ->
  'accum ->
...
val fold_lefti :
  (int -> 'accum -> ('m, 'num, 'prec, 'x_cd) Vec.t -> 'accum) ->
  'accum ->
  ('m, 'n, 'num, 'prec, 'a_cd) t -> 'accum
...
val fold_right :
  (('m, 'num, 'prec, 'x_cd) Vec.t -> 'accum -> 'accum) ->
  ('m, 'n, 'num, 'prec, 'a_cd) t ->
  'accum -> 'accum
...
val fold_righti :
  (int -> ('m, 'num, 'prec, 'x_cd) Vec.t -> 'accum -> 'accum) ->
  ('m, 'n, 'num, 'prec, 'a_cd) t ->
  'accum -> 'accum
...
val fold_top :
  ('accum -> ('n, 'num, 'prec, dsc) Vec.t -> 'accum) ->
  'accum ->
  ('m, 'n, 'num, 'prec, 'a_cd) t -> 'accum
...
val fold_topi :
  (int -> 'accum -> ('n, 'num, 'prec, dsc) Vec.t -> 'accum) ->
  'accum ->
  ('m, 'n, 'num, 'prec, 'a_cd) t -> 'accum
...
val fold_bottom :
  (('n, 'num, 'prec, dsc) Vec.t -> 'accum -> 'accum) ->
  ('m, 'n, 'num, 'prec, 'a_cd) t ->
  'accum -> 'accum
...
val fold_bottomi :
  (int -> ('n, 'num, 'prec, dsc) Vec.t -> 'accum -> 'accum) ->
  ('m, 'n, 'num, 'prec, 'a_cd) t ->
  'accum -> 'accum
...
(** The type of packages of existential quantified sized type:
    ...
    [exists m, n. (m, n, 'num, 'prec, 'cnt_or_dsc) Vec.t].
    @since 4.0.0 *)
...
val of_bigarray_c :
  ?share:bool ->
  ('num, 'prec, fortran_layout) Array2.t -> ('num, 'prec, 'cnt) dyn
